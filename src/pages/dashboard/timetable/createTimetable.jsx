...
import { addTimetable } from "../../../features/timetableSlice";
...
const disptach= useDispatch()
  ...
  const userClassroomIds = user?.classrooms.map((classroom) => classroom);
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (res.status === 201) {
        disptach(addTimetable(res.data));  // Add the timetable to Redux store
        setLoading(false);
        toast({
